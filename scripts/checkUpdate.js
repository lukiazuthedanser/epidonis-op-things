var currentVersion = '1.0.1-beta';
var versionURL = 'https://raw.githubusercontent.com/lukiazuthedanser/epidonis-op-things/main/mod.json';

function showUpdateDialog(current, latest) {
	var dialog = new Packages.mindustry.ui.dialogs.BaseDialog('Mod Update Available');
	...
	dialog.cont.row();
	dialog.cont.add('To update, go to the [yellow]Mods tab[], select [orange]OP Things[], and click [green]Reinstall[].').row();
	dialog.cont
